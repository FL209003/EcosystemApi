    ...
    public class SpeciesDTO
    {
        ...
        public Species TransformToObj()
        {
            Species s = new()
            {
                ...
                ImgRoute = ImgRoute,
                Security = Security,
                Ecosystems = Ecosystems != null ? new List<Ecosystem>(Ecosystems.Select(e => e.TransformToSimpleObj()).ToList()) : new List<Ecosystem>(),
                Threats = Threats != null ? new List<Threat>(Threats.Select(t => t.TransformToSimpleObj()).ToList()) : new List<Threat>(),
            };
            return s;
        }
        public Species TransformToSimpleObj()
        {
            Species s = new()
            {
                Id = Id,
                ...
                ImgRoute = ImgRoute,
                Security = Security,
                Ecosystems = Ecosystems != null ? new List<Ecosystem>(Ecosystems.Select(e => new Ecosystem() { Id = e.Id }).ToList()) : new List<Ecosystem>(),
